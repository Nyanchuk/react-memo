...
1. Создание суперсил -
    + Определить функциональность "суперсил" (подсказки и т.д.) - 30 мин
        ...
        3) Суперсила "ПРАВО НА ОШИБКУ"
            * Если игрок сомневается в выборе следующей карты, он может активировать "суперсилу" (в случае неудачи, игроку будет предоставлена еще одна попытка, но суперсила "право на ошибку" больше не будет доступка, т.к. игрок уже использовал этот шанс)
    - Визуал "суперсил" - 1,5 часа
    - Добавить описание каждой хэлпы на 3 секунды при наведении на "суперсилу"
