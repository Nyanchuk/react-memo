...
2. Доработка лидерборда - 
    - Определить функциональность ачивок и добавить графу "ДОСТИЖЕНИЯ":
        1) Игра пройдена без упрощенного режима (варианты актив/неатив)
        2) Игра пройдена без "Суперсил" (варианты актив/неатив)
    - Реализовать ачивки (в неативном состоянии)
    - Реализовать для 1/2/3 мест золотое/серебрянное/бронзовое (или др.) визуальное оформление (акцент на первой тройке победителей)
    - Внедрить новые АПИ-запросы на получение/добавление лидеров на ЛИДЕРБОРД !!!
